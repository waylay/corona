...
/***/ "./resources/assets/js/bootstrap-dropdownhover.js":
...
+function ($) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      var options = $.extend({}, Dropdownhover.DEFAULTS, settings, (typeof option === 'undefined' ? 'undefined' : _typeof(option)) == 'object' && option);
  ...
  $(document).ready(function () {
    if ($(window).width() >= 992) {
      // Breakpoin plugin is activated (992px)
    ...
    resizeTimer = setTimeout(function () {
      if ($(window).width() >= 992) // Breakpoin plugin is activated (992px)
        ...
        $('[data-hover="dropdown"]').each(function () {
          ...
          if ($(this).hasClass('dropdown-toggle')) $(this).parent('.dropdown').find('.dropdown').addBack().off('mouseenter.bs.dropdownhover mouseleave.bs.dropdownhover');else $(this).find('.dropdown').off('mouseenter.bs.dropdownhover mouseleave.bs.dropdownhover');
        });
    }, 200);
  });
}(jQuery);
...
module.exports = __webpack_require__("./resources/assets/js/bootstrap-dropdownhover.js");
