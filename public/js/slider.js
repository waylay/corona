...
(function ($) {
  ...
  $.fn.slippry = function (options) {
    var slip, el, prepareFiller, getFillerProportions, init, updateCaption, initPager, initControls, ready, transitionDone, whichTransitionEvent, initCaptions, updatePager, setFillerProportions, doTransition, updateSlide, openSlide, updateControls, updatePos, supports, preload, start, elFromSel, doKens;
    ...
    elFromSel = function elFromSel(sel, prop) {
    ...
    setFillerProportions = function setFillerProportions(width, height) {
    ...
    getFillerProportions = function getFillerProportions($slide) {
      var width, height;
    ...
    prepareFiller = function prepareFiller() {
    ...
    transitionDone = function transitionDone() {
    ...
    updatePos = function updatePos(slide) {
    ...
    openSlide = function openSlide(slide) {
    ...
    initCaptions = function initCaptions() {
      if (slip.settings.captions !== false) {
    ...
    preload = function preload(slides) {
...
module.exports = __webpack_require__("./resources/assets/js/slider.js");
